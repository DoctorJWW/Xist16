make:
	...
	cc65 -Osir -Cl -t cx16 -I inc xist_log.c    -o lib/xist_log.s
	...
	ca65 -t cx16 lib/xist_log.s    -o lib/xist_log.o
	...
	ar65 r lib/xist.lib lib/xist_gfx.o lib/xist_input.o lib/xist_log.o lib/xist_mem.o lib/xist_text.o lib/xist_tiles.o lib/xist_utils.o
	rm -f lib/*.o lib/*.s